...
namespace AssMngSys
{
    public class MysqlHelper
    {
        ...
        public static string connectionString = "server=localhost;user id=root; password=gv; database=gvdb; pooling=false;port=3306";
        ...
        #endregion
        #region 记录错误日志
        public static void WriteIntoLog(string strExp)
        {
            try
            {
                FileStream fs = new FileStream("D:\\Log\\testlog.txt", FileMode.Append);
